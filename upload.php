...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['userFiles']) && !empty($_FILES['userFiles']['name'][0])) {
        ...
        for ($i = 0; $i < $fileCount; $i++) {
            ...
            // Allowed file types
            $allowedTypes = ['html', 'js', 'jpg', 'pdf', 'plp', 'zip', 'png', 'otf', 'ttf', 'mp4'];
            ...
            if ($fileSize <= 10 * 1024 * 1024) {
                ...
                if (in_array(strtolower($fileType), $allowedTypes)) {
                    ...
                    if (file_exists($destination)) {
                        $successMessages[] = "Error: A file with the name '$fileName' already exists. Please rename the file and host free.";
                    } else {
                ...
                $successMessages[] = "File '$fileName' exceeds 10 MB. Please upload a smaller file or subscribe unlimited with vip.";
            }
        }
    } else {
...
<head>
    ...
    <title>JOY FREE HOSTING SERVICE</title>
